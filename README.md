...
O objetivo deste desafio é avaliar a competência técnica dos candidatos a desenvolvedor Golang na **Mobilitee**. Será solicitado o desenvolvimento de uma API restful para fazer o Controle de Devices cadastrados no sistema. As regras deste Controle de Devices estão detalhada neste documento.
